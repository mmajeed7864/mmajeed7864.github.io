import { convertWeight, escapeHtml, formatDate, sessionVolume } from "../core/utils.mjs";
import { sessionsThisWeek } from "../domain/decisions.mjs";
import { emptyState, icon, sessionHistoryRow } from "./components.mjs";
