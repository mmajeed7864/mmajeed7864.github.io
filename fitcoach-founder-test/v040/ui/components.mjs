...
const ICONS = Object.freeze({
  ...
  sync: '<path d="M20 7h-6V1M4 17h6v6M18.5 12a7 7 0 0 0-12-4L4 10M5.5 12a7 7 0 0 0 12 4L20 14"/>',
  volume: '<path d="M4 10v4h4l5 4V6L8 10zM17 9a4 4 0 0 1 0 6M19 6a8 8 0 0 1 0 12"/>',
  info: '<circle cx="12" cy="12" r="9"/><path d="M12 11v6M12 7h.01"/>',
  "external-link": '<path d="M14 4h6v6M20 4l-9 9"/><path d="M19 13v6a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1V6a1 1 0 0 1 1-1h6"/>',
