...
const CACHE = "fitcoach-symbio-v0423";

const SHELL_ASSETS = Object.freeze([
  "./",
  "./index.html?v=0423",
  "./manifest.webmanifest?v=0423",
  "./assets/icon-symbio.svg?v=0423",
  "./v040/styles.css?v=0423",
  "./v040/premium-redesign.css?v=0423",
  "./v040/app.js?v=0423",
]);
  ...
  if (event.request.mode === "navigate") {
    event.respondWith(
      fetch(event.request)
        ...
        .catch(() => caches.match("./").then(response => response || caches.match("./index.html?v=0423")))
    );
    return;
  }

  const versioned = url.searchParams.get("v") === "0423";
