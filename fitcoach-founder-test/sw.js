...
const CACHE = "fitcoach-symbio-v0420";

const SHELL_ASSETS = Object.freeze([
  "./",
  "./index.html?v=0420",
  "./manifest.webmanifest?v=0420",
  "./assets/icon-symbio.svg?v=0420",
  "./v040/styles.css?v=0420",
  "./v040/premium-redesign.css?v=0420",
  "./v040/app.js?v=0420",
]);
  ...
  if (event.request.mode === "navigate") {
    event.respondWith(
      fetch(event.request)
        ...
        .catch(() => caches.match("./").then(response => response || caches.match("./index.html?v=0420")))
    );
    return;
  }

  const versioned = url.searchParams.get("v") === "0420";
