...
FitCoach v0.4.5 is the active runtime (cache generation 0427 carries premium coach actions, first-day progress visuals, polished exercise rails, range-safe motion playback, navy anatomy studio artwork, bodyweight labels, and blue-consistent onboarding):

- document shell: `index.html?v=0427`
- stylesheets: `v040/styles.css?v=0427` and `v040/premium-redesign.css?v=0427`
- ES-module entry: `v040/app.js?v=0427`
- service worker cache: `fitcoach-symbio-v0427`
